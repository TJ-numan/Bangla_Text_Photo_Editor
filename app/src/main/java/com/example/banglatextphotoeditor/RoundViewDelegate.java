...
public class RoundViewDelegate {
    ...
    private void setDrawable(GradientDrawable gradientDrawable, int i, int i2) {
        ...
        if (this.cornerRadius_TL > 0 || this.cornerRadius_TR > 0 || this.cornerRadius_BR > 0 || this.cornerRadius_BL > 0) {
            ...
            float f = (float) this.cornerRadius_TL;
            fArr[0] = f;
            fArr[1] = f;
            float f2 = (float) this.cornerRadius_TR;
            fArr[2] = f2;
            fArr[3] = f2;
            float f3 = (float) this.cornerRadius_BR;
            fArr[4] = f3;
            fArr[5] = f3;
            float f4 = (float) this.cornerRadius_BL;
            fArr[6] = f4;
            fArr[7] = f4;
    ...
    public void setBgSelector() {
        ...
        if ((view2 instanceof TextView) && this.textPressColor != Integer.MAX_VALUE) {
            ((TextView) view2).setTextColor(new ColorStateList(new int[][]{new int[]{-16842919}, new int[]{16842919}}, new int[]{((TextView) view2).getTextColors().getDefaultColor(), this.textPressColor}));
        }
    }
