...
import com.example.banglatextphotoeditor.RoundFrameLayout;
        ...
        public ColorViewHolder(View view) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                public final void onClick(View view) {
                    ColorViewHolder.this.lambda$new$0$ColorAdapter$ColorViewHolder(view);
                }
            });
        }

        public /* synthetic */ void lambda$new$0$ColorAdapter$ColorViewHolder(View view) {
