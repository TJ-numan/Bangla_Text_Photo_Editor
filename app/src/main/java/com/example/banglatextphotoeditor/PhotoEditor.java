...
import com.example.banglatextphotoeditor.Fragments.OnPhotoEditorListener;
import com.jblabs.lipiyon.C1068R;
import com.jblabs.lipiyon.photoeditor.MultiTouchListener;
import com.jblabs.lipiyon.photoeditor.SaveSettings;
import java.io.File;
...
public class PhotoEditor implements BrushViewChangeListener {
        ...
        multiTouchListener.setOnGestureControl(new MultiTouchListener.OnGestureControl() {
            ...
            public void onSingleTap() {
                ...
                if (PhotoEditor.this.mOnPhotoEditorListener != null) {
                    PhotoEditor.this.mOnPhotoEditorListener.onClickGetImageViewListener(imageView2, view);
                }
            }
        });
    ...
    public void addText(Typeface typeface, String str, int i) {
        ...
        StrokeTextView strokeTextView = (StrokeTextView) layout.findViewById(R.id.tvPhotoEditorText);
        final View findViewById = layout.findViewById(R.id.imgPhotoEditorClose);
        final View findViewById2 = layout.findViewById(R.id.imgPhotoEditorZoom);
        RoundFrameLayout roundFrameLayout = (RoundFrameLayout) layout.findViewById(R.id.frmBorder_highlight);
        final FrameLayout frameLayout = (FrameLayout) layout.findViewById(R.id.frmBorder);
        strokeTextView.setText(str);
        strokeTextView.setTextColor(i);
        C11613 r6 = new Runnable() {
            public void run() {
                findViewById.setVisibility(View.GONE);
                findViewById2.setVisibility(View.GONE);
                frameLayout.setBackgroundResource(0);
        ...
        multiTouchListener.setOnGestureControl(new MultiTouchListener.OnGestureControl() {
            ...
            public void onClick() {
                ...
                PhotoEditor.this.handler.removeCallbacks(r5);
                PhotoEditor.this.handler.postDelayed(r5, 2500);
            }
            ...
            public void onDoubleClick() {
                ...
                if (PhotoEditor.this.mOnPhotoEditorListener != null) {
                    PhotoEditor.this.mOnPhotoEditorListener.onEditTextChangeListener(view3, charSequence, currentTextColor);
                }
            }
    ...
    /* renamed from: com.jblabs.lipiyon.photoeditor.PhotoEditor$11 */


    private View getLayout(final ViewType viewType) {
        int i = C115911.$SwitchMap$com$jblabs$lipiyon$photoeditor$ViewType[viewType.ordinal()];
        final View view = null;
        if (i == 1) {
            view = this.mLayoutInflater.inflate(R.layout.view_photo_editor_text, (ViewGroup) null);
            TextView textView = (TextView) view.findViewById(R.C1070id.tvPhotoEditorText);
            ...
            view = this.mLayoutInflater.inflate(C1068R.layout.view_photo_editor_image, (ViewGroup) null);
        } else if (i == 3) {
            View inflate = this.mLayoutInflater.inflate(C1068R.layout.view_photo_editor_emoji, (ViewGroup) null);
            TextView textView2 = (TextView) inflate.findViewById(C1068R.C1070id.tvPhotoEditorText);
            if (textView2 != null) {
        ...
        if (view != null) {
            ...
            final FrameLayout frameLayout = (FrameLayout) view.findViewById(C1068R.C1070id.frmBorder);
            final View findViewById = view.findViewById(C1068R.C1070id.imgPhotoEditorClose);
            ...
            final View findViewById2 = view.findViewById(C1068R.C1070id.imgPhotoEditorZoom);
    ...
    public void zoomAndRotateSticker(View view, MotionEvent motionEvent, FrameLayout frameLayout, View view2, View view3, float f, float f2) {
        if (view != null) {
            ...
            int dimension = (int) (this.context.getResources().getDimension(C1068R.dimen.frame_margin) / floatA);
    ...
    public void clearHelperBox() {
        for (int i = 0; i < this.parentView.getChildCount(); i++) {
            ...
            FrameLayout frameLayout = (FrameLayout) childAt.findViewById(C1068R.C1070id.frmBorder);
            if (frameLayout != null) {
                frameLayout.setBackgroundResource(0);
                View findViewById = childAt.findViewById(C1068R.C1070id.imgPhotoEditorClose);
                if (findViewById != null) {
                    findViewById.setVisibility(8);
                }
                View findViewById2 = childAt.findViewById(C1068R.C1070id.imgPhotoEditorZoom);
                if (findViewById2 != null) {
    ...
    public Bitmap BITMAP_RESIZER(Bitmap bitmap, int i, int i2) {
        ...
        canvas.drawBitmap(bitmap, f3 - ((float) (bitmap.getWidth() / 2)), f4 - ((float) (bitmap.getHeight() / 2)), new Paint(2));
        return createBitmap;
    }
